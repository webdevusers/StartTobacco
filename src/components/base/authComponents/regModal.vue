    ...
    <div class="content">
        <div class="content-text">
            ...
            <div class="content-text__desc">
                Створіть свій особистий кабінет
            </div>
        </div>
        <div class="content-form">
            ...
            <div class="content-form__items">
                ...
                <div class="content-form__items-item">
                    <input type="text" placeholder="Моб. телефон" v-model="phone" required>
                </div>
                <div class="content-form__items-item">
                    <input type="password" placeholder="Пароль" v-model="password" required>
                </div>
                <div class="content-form__items-item">
                    <input type="password" placeholder="Підтвердити пароль" v-model="passwordConfim" required>
                </div>
            </div>
            <div class="content-form__button" @click="handleAuth()">
                Створити
            </div>
